...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    protected static final String[] PLAYER_CLASSES = { "student_player.StudentPlayer"}; //"Saboteur.RandomSaboteurPlayer"// "alpha_beta.AlphaBetaPlayer" //"Saboteur.StudentPlayer"
